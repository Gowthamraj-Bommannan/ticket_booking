...
class PaymentTransaction(models.Model):
    ...
    status = models.CharField(max_length=20, choices=Choices.PAYMENT_STATUS_CHOICES)
    payment_method = models.CharField(max_length=20, choices=Choices.PAYMENT_METHOD_CHOICES)
