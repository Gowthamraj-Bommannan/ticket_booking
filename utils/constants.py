...
class TrainMessage:
    ...
    SCHEDULE_DIRECTION_NOT_BE_SAME = "Train direction should be sequential. (Up and down)"
    SCHEDULE_ALREADY_EXISTS = "Train already has a schedule with same start time and diretion."
